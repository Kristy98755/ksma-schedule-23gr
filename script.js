document.addEventListener("DOMContentLoaded", function() {
    ...
    const overrides = {
		...
		"Пропедевтика внутренних болезней (фак.тер)|Практика|CurrWeek":"<a href='https://jumpshare.com/share/bfTAtdSCdo8dWEkKGvTl'target='_blank'>Пропедевтика внутренних болезней</a>",
